...
import com.alvaro.hero_datasource.network.EndPoints.BASE_URL
import com.alvaro.hero_domain.Hero
import com.alvaro.hero_domain.getHeroAttackType
import com.alvaro.hero_domain.getHeroAttributeFromAbbreviation
import com.alvaro.hero_domain.getHeroRole
...
fun HeroDto.toHero(): Hero {
    return Hero(
        ...
        primaryAttribute = getHeroAttributeFromAbbreviation(primaryAttribute),
